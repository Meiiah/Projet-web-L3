...
<head>
    ...
    <link href="css/surcouche.css" rel="stylesheet" media="all">

</head>

<body class="animsition">
    <div class="page-wrapper">
      <!-- <p>JE PREND DE LA PLACE </p>
      <p>JE PREND DE LA PLACE </p>
      <p>JE PREND DE LA PLACE </p>
      <input type="button" onclick="test()" value="test" />
      <input type="button" onclick="CreateTableFromJSON()" value="Create Table From JSON" />
      <p id="showData"></p>
      <input type="button" onclick="requete()" value="requet" />
      <p id="jemarche"></p>
      <p id="caca"></p> -->
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                            ...
                            <div class="col-lg-6">
                                <div class="au-card recent-report">
                                    <div class="au-card-inner">
                                        <h3 class="title-2">Tweet des 7 derniers jours</h3>
                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                <h2 class="title-1 m-b-25">Liste des Tweets</h2>
                            ...
                            <div class="col-lg-3">
                                <h2 class="title-1 m-b-25">Top Tweet</h2>
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <form class="form-header" action="" method="POST">
                                <input class="au-input au-input--xl" type="text" id="search" name="search" placeholder="#Hashtag" />
                                <button class="au-btn--submit" type="submit" onclick="getHashtag();">
